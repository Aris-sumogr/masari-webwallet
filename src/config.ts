...
global.config = {
	apiUrl:typeof window !== 'undefined' && window.location ? window.location.href.substr(0,window.location.href.lastIndexOf('/')+1)+'api/' : 'http://206.189.200.153/api/',
	trustedDaemonsAddresses:[
		'https://206.189.200.153:38084/'
	],
